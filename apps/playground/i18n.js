const messages = {
  en: {
    ...
    open: 'Open DXF / KJD / KJP', openShort: 'Open', fileOpenErrorTitle: 'Could not open file', fileOpenRetry: 'Choose another file', dismiss: 'Dismiss', snapshot: 'Snapshot', save: 'Download KJP', saveShort: 'Save KJP', saveLocalShort: 'Save local', export: 'Export DXF ↗', exportShort: 'DXF', memory: 'In memory', file: 'FILE', view: 'VIEW', construct: 'CONSTRUCT',
  ...
  zh: {
    ...
    open: '打开 DXF / KJD / KJP', openShort: '打开', fileOpenErrorTitle: '无法打开文件', fileOpenRetry: '重新选择文件', dismiss: '关闭', snapshot: '快照', save: '下载 KJP', saveShort: '保存 KJP', saveLocalShort: '保存到本地', export: '导出 DXF ↗', exportShort: '导出 DXF', memory: '仅在内存中', file: '文件', view: '视图', construct: '构造',
