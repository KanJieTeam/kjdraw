const messages = {
  en: {
    ...
    agent: 'AGENT REVIEW', agentTitle: 'Review drawing changes', agentHelp: 'Preview an example change on the drawing, then apply it or keep the original.', ready: 'Ready',
  ...
  zh: {
    ...
    agent: 'AGENT 审核', agentTitle: '审核图纸修改', agentHelp: '先查看图纸上的修改预览，再决定应用修改，或保留原图。', ready: '就绪',
