...
Excluded: account and organization services, reports and MDB data, historical case knowledge, third-party CAD templates and legacy asset libraries, private configuration, keys, caches and original git history. Compatibility identifiers in inherited contracts do not include or license third-party assets.
