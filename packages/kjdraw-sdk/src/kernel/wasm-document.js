// Generated from wasm-document.ts by scripts/build-typescript.mjs. Do not edit directly.
...
function failure(exports, operation, result) {
    ...
    return new KJValidationError(`KJCore ${operation} 失败：${MODEL_ERRORS[code] ?? `错误 ${code || 'unknown'}`}`, {
        code,
        operation
    });
}
function assertDocumentAbi(source) {
    ...
    for (const name of [
        'kjcore_alloc_u8',
        'kjcore_free_u8',
        'kjcore_document_open_kjd',
        'kjcore_document_close',
        'kjcore_document_validate',
        'kjcore_document_revision',
        'kjcore_document_serialize_kjd',
        'kjcore_document_fingerprint',
        'kjcore_document_commit_kjd',
...
export class KJCoreDocumentSession {
    ...
    commit(source, expectedRevision = this.revision) {
        ...
        const result = withUtf8(this.#exports, source, (pointer, length)=>Number(this.#exports.kjcore_document_commit_kjd(this.#handle, pointer, length, expectedRevision)));
