// Generated from deployment.ts by scripts/build-typescript.mjs. Do not edit directly.
...
const REQUIRED_METHODS = deepFreeze({
    [KJ_PROVIDER_TYPES.PROJECT_STORE]: [
        'loadProject',
        'saveProject'
    ],
    [KJ_PROVIDER_TYPES.COMPUTE]: [
        'execute'
    ],
    [KJ_PROVIDER_TYPES.SCENE]: [
        'openScene',
        'queryViewport'
    ]
});
function normalizeProvider(type, provider) {
    ...
    return Object.freeze({
        ...
        id,
        type,
        locality: String(provider.locality ?? 'host-defined')
    });
}
export class KJDeploymentRegistry {
    #providers = new Map(Object.values(KJ_PROVIDER_TYPES).map((type)=>[
            type,
            new Map()
        ]));
    ...
    list(type) {
        ...
        return [
            ...this.#providers.get(type).values()
        ];
    }
}
