...
export const KJDRAW_GEOLOGY_KNOWLEDGE_PACK: ReadonlyDeep<KJKnowledgePack> = validateKnowledgePack({
  ...
  rules: {
    ...
    'geology-column-layout': {
      ...
      titleMarginFacts: [{ key: 'recordNumber', label: '记录号', separator: ':', edge: 'top', anchor: 'right', offset: [-16, -18],
        height: 2, textWidthFactor: 0.8, horizontalAlignment: 'right', verticalAlignment: 'baseline', rotationDegrees: 0 }],
      textFlow: {
      ...
      headerGrid: {
        rows: [
          ...
          [{ role: 'initialWaterDepth', label: '初见水位(m)', optional: true },
