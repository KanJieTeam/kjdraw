...
export const KJDRAW_MECHANICAL_FLANGE_CORE_KNOWLEDGE_PACK = validateKnowledgePack({
  ...
  sources: [{
    ...
    license: 'MIT',
    contentHash: stableHash('flange-views:concentric-rings:square-hole-pitch:source-measured-relative-end-outlines:side-axis:symmetric-meridian-profile:native-derived-dimensions:inset-frame:semantic-title-grid:bounded-grid-segments:source-sheet-notes:v1.5'),
  }],
  ontology: {
    objectKinds: ['flange', 'bore', 'concentric-ring', 'square-hole-pattern', 'end-view-outline', 'side-view-axis', 'symmetric-meridian-profile', 'native-dimension', 'sheet-frame', 'title-grid', 'sheet-note'],
