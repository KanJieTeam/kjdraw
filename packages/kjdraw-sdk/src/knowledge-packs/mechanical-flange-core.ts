...
export const KJDRAW_MECHANICAL_FLANGE_CORE_KNOWLEDGE_PACK = validateKnowledgePack({
  ...
  rules: {
    ...
    nativeEntities: ['POINT', 'CIRCLE', 'LINE', 'ARC', 'TEXT', 'SOLID', 'HATCH', 'INSERT', 'ATTDEF', 'ATTRIB', 'WIPEOUT'],
  },
})
