...
const openHatchPatterns = [
    {
        name: 'GEO_FILL',
        description: 'Irregular crossed fill',
        lines: [
            {
                angle: Math.PI / 4,
                base: [
    ...
    {
        name: 'GEO_TOPSOIL',
        description: 'Sparse organic topsoil marks',
        lines: [
            {
                angle: 0,
                base: [
    ...
    {
        name: 'GEO_SILTY_CLAY',
        description: 'Short horizontal strokes with sparse dots',
        lines: [
            {
                angle: 0,
                base: [
    ...
    {
        name: 'GEO_SILT',
        description: 'Fine broken horizontal strokes',
        lines: [
            {
                angle: 0,
                base: [
    ...
    {
        name: 'GEO_SAND',
        description: 'Dense granular dots',
        lines: [
            {
                angle: 0,
                base: [
    ...
    {
        name: 'GEO_GRAVEL',
        description: 'Coarse crossed grains',
        lines: [
            {
                angle: Math.PI / 4,
                base: [
    ...
    {
        name: 'GEO_WEATHERED_ROCK',
        description: 'Broken inclined bedding',
        lines: [
            {
                angle: Math.PI / 6,
                base: [
    ...
    {
        name: 'GEO_LOESS',
        description: 'Vertical pore marks and fine dots',
        lines: [
            {
                angle: Math.PI / 2,
                base: [
    ...
    {
        name: 'GEO_COLLAPSIBLE_LOESS',
        description: 'Pore marks with collapse markers',
        lines: [
            {
                angle: Math.PI / 2,
                base: [
    ...
    {
        name: 'GEO_PALEOSOL',
        description: 'Soil horizon dash and dot bands',
        lines: [
            {
                angle: 0,
                base: [
    ...
    {
        name: 'GEO_NODULE',
        description: 'Widely spaced nodule points',
        lines: [
            {
                angle: 0,
                base: [
...
const openHatchMappings = {
    fill: 'GEO_FILL',
    'cultivated-soil': 'GEO_TOPSOIL',
    clay: 'GEO_FINE_SOIL',
    'silty-clay': 'GEO_SILTY_CLAY',
    silt: 'GEO_SILT',
    sand: 'GEO_SAND',
    gravel: 'GEO_GRAVEL',
    rock: 'GEO_ROCK',
    'weathered-rock': 'GEO_WEATHERED_ROCK',
    loess: 'GEO_LOESS',
    'loess-collapsible': 'GEO_COLLAPSIBLE_LOESS',
    'loess-like': 'GEO_LOESS_LIKE',
    paleosol: 'GEO_PALEOSOL',
    'calcareous-nodule': 'GEO_NODULE'
};
export const KJDRAW_GEOLOGY_KNOWLEDGE_PACK = validateKnowledgePack({
    ...
    rules: {
        'hatch-pattern-catalog': {
            version: '1.0.0',
            contentHash: stableHash(openHatchPatterns),
            patterns: openHatchPatterns,
            mappings: openHatchMappings
        },
