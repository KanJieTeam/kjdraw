...
export const KJ_CORE_COMMAND_CAPABILITIES = deepFreeze({
  ...
  HATCH: { domain: 'entity', entityType: 'HATCH', boundaryModes: ['polyline', 'line-arc-edges', 'full-ellipse-edge'] },
  HATCHEDIT: { domain: 'entity', entityType: 'HATCH', operations: ['update-pattern', 'add-island', 'replace-island', 'remove-island'], exactSourceTypes: ['CIRCLE', 'ELLIPSE', 'LINE', 'ARC'], openEllipseArcBoundary: false, stableIdentity: true },
