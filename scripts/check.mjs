...
for(const p of files){
  ...
  if(p!=='scripts/check.mjs'&&extname(p)!=='.md'&&/(?:KJDrawAssets|LegacyVendorAssets|VENDOR_REVERSE|[A-Z]:\\product\\|\/product-ai\/tools\/kjdraw)/i.test(text))failures.push(`Downstream implementation reference in public code: ${p}`)
  if(extname(p)==='.md'){
