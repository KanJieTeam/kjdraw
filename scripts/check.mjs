...
for(const required of ['LICENSE','NOTICE','README.md','README.zh-CN.md','CONTRIBUTING.md','SECURITY.md','docs/assets/hero.svg','docs/assets/mark.svg','web/public/kjcore/kjcore.wasm'])if(!files.includes(required))failures.push(`Missing ${required}`)
