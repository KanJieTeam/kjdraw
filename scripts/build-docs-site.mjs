...
@media(max-width:980px){html[data-page="introduction"] .page-hero{display:flex;align-items:stretch;gap:20px;padding:48px 24px}html[data-page="introduction"] .home-preview{width:100%;max-width:720px}}
