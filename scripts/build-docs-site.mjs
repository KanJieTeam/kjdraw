    ...
    <main>
      <div class="content">
        <article class="lang-en" lang="en" id="en-${page.slug}">
          ...
          <p class="lead">${escapeHtml(page.summary.en)}</p>${homeActions}${atRoot ? '</div>' : ''}${homePreview}</header>${homeSections}${homeAgentMatrix}${portal('en') ? `\n          ${portal('en')}` : ''}
          ${pageBody('en')}
        </article>
        <article class="lang-zh" lang="zh-CN" id="zh-${page.slug}">
          ...
          <p class="lead">${escapeHtml(page.summary.zh)}</p>${homeActions}${atRoot ? '</div>' : ''}${homePreview}</header>${homeSections}${homeAgentMatrix}${portal('zh') ? `\n          ${portal('zh')}` : ''}
          ${pageBody('zh')}
        </article>
