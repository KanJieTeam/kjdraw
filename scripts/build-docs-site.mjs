...
const homeStyle = `
.home-hero{min-height:510px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:92px 24px 76px;text-align:center;background:#fff;border-bottom:0}
.home-hero .eyebrow{margin-bottom:22px;color:#677180;font:600 11px/1.4 Inter,"Segoe UI",Arial,sans-serif;letter-spacing:.035em;text-transform:none}
.home-hero h1{max-width:1100px;margin:0 0 24px;font-size:clamp(44px,4.4vw,64px);font-weight:600;line-height:1.08;letter-spacing:-.06em}
.home-hero .lead{max-width:740px;margin:0;padding:0;border:0;color:#556171;font-size:19px;line-height:1.65}
.home-hero .home-actions{margin-top:34px}
.home-entry-section{width:min(1100px,calc(100% - 48px));display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin:0 auto 22px;border-top:1px solid #dfe4ea;border-bottom:1px solid #dfe4ea}
.home-entry-section a{min-width:0;display:flex;flex-direction:column;gap:8px;padding:28px 28px 30px;color:#202935;text-decoration:none}
.home-entry-section a+a{border-left:1px solid #dfe4ea}
.home-entry-section a:hover,.home-entry-section a:focus-visible{background:#f7f9fc;outline:0}
.home-entry-section > a > span{color:#5b687b;font:600 10px/1.4 Consolas,monospace;letter-spacing:.08em}
.home-entry-section strong{color:#172130;font-size:17px;font-weight:600}
.home-entry-section small{color:#667282;font-size:13px;line-height:1.5}
.home-live-demo{width:min(1100px,calc(100% - 48px));margin:52px auto 84px}.home-live-heading{display:flex;align-items:end;justify-content:space-between;gap:24px;margin-bottom:18px}.home-live-heading h2{margin:0 0 7px;color:#172130;font-size:27px;font-weight:600;letter-spacing:-.035em}.home-live-heading p{max-width:620px;margin:0;color:#667282;font-size:14px;line-height:1.6}.home-live-heading>a{flex:0 0 auto;color:#245b46;font-size:13px;font-weight:600;text-decoration:none}.home-live-heading>a:hover{text-decoration:underline;text-underline-offset:3px}.home-live-frame{height:560px;overflow:hidden;border:1px solid #cfd7df;border-radius:7px;background:#111920}.home-live-frame iframe{display:block;width:100%;height:100%;border:0}
@media(max-width:780px){.home-live-demo{width:calc(100% - 40px);margin:38px auto 56px}.home-live-heading{align-items:start;flex-direction:column;gap:10px}.home-live-heading h2{font-size:23px}.home-live-heading p{font-size:13px}.home-live-frame{height:510px}}
@media(max-width:780px){.home-hero{min-height:440px;padding:70px 22px 54px}.home-hero h1{font-size:clamp(40px,9vw,56px)}.home-hero .lead{font-size:16px}.home-entry-section{width:calc(100% - 40px);grid-template-columns:1fr}.home-entry-section a{padding:20px 8px}.home-entry-section a+a{border-top:1px solid #dfe4ea;border-left:0}}
`
const showcaseStyle = `
